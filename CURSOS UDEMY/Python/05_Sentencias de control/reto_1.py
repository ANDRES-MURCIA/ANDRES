...
if valor_comprado >= compra_requerida and miembro == "si":
    print(f"Valor de la compra original: {valor_comprado}")
    print(
        f"""Cumple con los requisitos para el descuento del 10%.
        \nSaldo a pagar {valor_final_descuento_alto}"""
    )
    print(f"El descuento es: {descuento_alto}")

elif valor_comprado < compra_requerida and miembro == "si":
    print(f"Valor de la compra original: {valor_comprado}")
    print(
        f"""Cumple con los requisitos para el descuento del 5%.
        \nSaldo a pagar {valor_final_descuento_medio}"""
    )
    print(f"El descuento es: {descuento_medio}")
