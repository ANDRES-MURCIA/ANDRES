...
def obtener_datos_ventas():
    ...
    while True:
        ...
        producto = input("Ingrese el nombre del producto (o ingrese 'fin' para terminar): ")
...
producto_max_venta = reduce(lambda x, y: x if x[1] > y[1] else y, ventas_totales)
...
{producto_max_venta[0]} con ventas de {producto_max_venta[1]}
