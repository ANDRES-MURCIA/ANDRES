# IMPORTACIÓN DE LAS LIBRERIAS NECESARIAS PARA EL CÓDIGO
...
db_config = {
    "user": "root",  # NOMBRE DE USUARIO CON EL QUE SE CONECTA A MYSQL
    "password": "admin",  # CONTRASEÑA DE INGRESO A MYSQL
    "host": "127.0.0.1",  # DIRECCIÓN IP DEL HOST DEL SERVIDOR
    "port": 3307,  # IP DEL PUERTO
    "database": "trabajo",  # BASE DE DATOS CREADA Y USADA PARA TRABAJAR EL CÓDIGO
